...
code_diplome<-sample(c("Licence Pro", "Master"), size = n,prob = c(0.65, 0.35), replace= TRUE)
...
universite <- data.frame(q4_3 , q6_5, q6_6r, q6_7, q7_1, q8_1, q3_1_1, q3_1_2, q4_1, q8_2r, code_diplome, q8_3, c_sexe, q6_14a, dep30 , q6_9, q8_5, q2_2, boursier30, q2_4_1, q2_4_2, q2_4_3, q2_4_4, q2_4_5, q2_4_6, q2_4_7)
...
poursuiteMaster3 <-subset(dipMaster, q4_1 != 3) #15-16

poursuiteLic <-subset(dipLP, q3_1_1 != 3) #13-14
poursuiteLic2 <-subset(dipLP, q3_1_2 != 3) #14-15
poursuiteLic3 <-subset(dipLP, q4_1 != 3) #15-16
...
b<-c(pourcentage(dipMaster, poursuiteMaster),
     ...
     pourcentage(dipMaster, poursuiteMaster3),
     pourcentage(dipLP, poursuiteLic),
     pourcentage(dipLP, poursuiteLic2),
     pourcentage(dipLP, poursuiteLic3))
c<-c("2013-2014","2014-2015", "2015-2016","2013-2014", "2014-2015", "2015-2016")
...
ne<- data.frame(x,y)
plot<- ggplot(ne, aes(x=x, y = y/sum(y)*100)) + geom_bar(stat="identity")+
