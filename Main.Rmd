...
gender<-sample(c("M", "F"), n, prob=c(0.54, 0.46), replace=TRUE)

# Data frame avec l'ensemble des donnees
universite <- data.frame(q4_3, q6_5, q6_6r, q6_7, q7_1, q8_1, q8_2r, q8_3, gender)
head(universite, n=2)
```
...
plotInsertion<-ggplot(universite, aes(x=universite$insertion18, fill=universite$insertion18)) 
